...
const ProductDetails = () => {
        ...
        // update and find related products
        useEffect(()=>{
        ...
        <div className='sm:w-[90%] sm:ms-[5%] max-sm:px-3 pt-5'>
                ...
                <div className="max-w-6xl w-full px-6">
                        <p className="text-[black] dark:text-[white]">
                                <Link to={'/'} className="text-[#000000bf] hover:text-[black] dark:text-[#ffffff95] dark:hover:text-[white] duration-200">Home</Link> /
                                <Link to={'/products'} className="text-[#000000bf] hover:text-[black] dark:text-[#ffffff95] dark:hover:text-[white] duration-200"> Products</Link> /
                                <Link to={`/products/${product.category.toLowerCase()}`} className="text-[#000000bf] hover:text-[black] dark:text-[#ffffff95] dark:hover:text-[white] duration-200"> {product.category}</Link> /
                                <span className="text-[red] cursor-default"> {product.name}</span>
                        </p>
                        ...
                        <div className="flex flex-col md:flex-row gap-16 mt-4">
                                ...
                                <h1 className="text-3xl font-medium text-[black] dark:text-[white] cursor-default">{product.name}</h1>
                                ...
                                <div className="flex items-center gap-0.5 mt-1">
                                        ...
                                        <p className="text-base ml-2 text-[#615fff]">(4)</p>
                                </div>

                                <div className="mt-6">
                                        <p className="text-[red] line-through cursor-default">MRP: {currency}{product.price}</p>
                                        <p className="text-2xl font-medium text-black dark:text-white cursor-default">MRP: {currency}{product.offerPrice}</p>
                                        <span className="text-gray-500/70 cursor-default">(inclusive of all taxes)</span>
                                </div>

                                <p className="text-base font-medium mt-6 text-black dark:text-white cursor-default">About Product</p>
                                <ul className="list-disc ml-4 text-gray-500/70 dark:text-[#ffffff84] cursor-default">
                                ...
                                <div className="flex items-center mt-10 gap-4 text-base">
                                        <button className="w-full py-3.5 cursor-pointer font-medium bg-[#cccccccf] text-black rounded-md hover:bg-gray-200 transition duration-300" onClick={()=> addToCart(product._id)} >
                                                Add to Cart
                                        </button>
                                        <button className="w-full py-3.5 cursor-pointer font-medium bg-[#008000b5] text-white hover:bg-[green] transition duration-300 rounded-md" onClick={()=> {addToCart(product._id); navigate('/cart')}} >
                                                Buy now
                                        </button>
                                </div>
                                </div>
                ...
                <div className='mt-10 sm:mt-20'>
                        <h2 className='text-black dark:text-white text-center  text-2xl sm:text-3xl tracking-[5px] cursor-default'>Similar products</h2>
                        <div className='grid grid-cols-2 sm:grid-cols-5 gap-4 mt-10 sm:mt-20'>
                        ...
                        <button className="py-3.5 sm:px-15 max-sm:w-[70%] mt-15 ms-[50%] rounded-md  cursor-pointer font-medium bg-[#008000b5] text-white hover:bg-[green] transform -translate-x-1/2 duration-300" onClick={()=> navigate('/products')} >
                                Show More
                        </button>
                </div>
        </div>
