...
const Cart = () => {
    ...
    const {cartTotalAmount, userAddress,setUserAddress, currency, countCart,cartItems, removeFromCart, navigate, products, paymentType, setPaymentType}= useAppContext();
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    <div className='flex items-center'>
                                        <p className=" group-hover:text-black max-sm:dark:group-hover:text-white duration-300">Qty: {cartItems[product._id]}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <p className="text-center group-hover:text-black max-sm:dark:group-hover:text-white duration-300">${product.offerPrice * product.quantity}</p>
