        ...
        {filterProducts.length > 0 ? (
                <div className='grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 mt-5'>
                        {filterProducts.map((product,index)=>(
                                <div onClick={()=>navigate(`/products/${product.category.toLowerCase()}/${product._id}`)} key={index} className="border border-gray-500/20  dark:border-white rounded-md px-4 py-8 bg-white dark:bg-black hover:scale-105 duration-300 group cursor-pointer">
                ...
                <div className="text-gray-500/60 text-sm">
                        ...
                        <div className='h-[30vh] sm:h-[50vh] lg:h-[40vh]'>
