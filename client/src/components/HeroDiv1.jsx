    ...
    <div className='max-sm:h-[20rem] max-sm:px-2 h-[35rem] sm:w-[90%] sm:ms-[5%] rounded-2xl relative'>
        ...
        <div className='absolute max-sm:top-[60%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                ...
                <div className='flex max-sm:flex-col gap-4 sm:mt-[3rem] mt-[1rem] items-center'>
                        <Link to={'/products'} className='px-6 py-2 rounded-md bg-[green] text-center font-medium text-white tracking-[2px]'>Shop now</Link>
                        <Link to={'/products'} className='px-2 py-2 group font-medium text-center border-b-1 border-l-3 max-sm:my-2 text-white tracking-[2px] hidden sm:block'>Explore <span className='group-hover:text-[red] duration-300'>deals</span></Link>
                </div>
        </div>
    </div>
  )
